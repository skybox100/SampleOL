...
public class DBConnection {
	...
	String url = "jdbc:sqlserver://211.9.3.55;databaseName=SmartDB";
	String url2 = "jdbc:sqlserver://211.9.3.55;databaseName=SmartPushDB";
	...
	public ArrayList<Beacons> getBeaconsList(String reg, String rc) {
	...
	public ArrayList<Beacons> getBeaconById(String beaconId) {
		...
		try {
			...
			while(rs.next()) {				
				...
				Beacons b= new Beacons(Uuid,Latitude,Longitude,EquipType,EquipTypeCode,EquipId,ModelName,Manufacturer,Regiment,RegimentCode,RegimCompany,RegimCompanyCode,EquipLocation,RoomName,RoomNumber,Remark);
		...
		if(reg.equals("전체") && rc.equals("전체")) {
			...
			try {
				...
				while(rs.next()) {
					...
					location = new Location( serviceNumber,  userKey,  name,  rank,  regiment,
							 regimCompany,  isDevice,  duty,  latitude,  longitude,  timestamp,
							 mobileNumber,  etc,  EquipLocation,  RoomName) ;
					locations.add(location);
				}
			} catch (SQLException e) {
				// TODO Auto-generated catch block

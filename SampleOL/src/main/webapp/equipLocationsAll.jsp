...
<%
	...
	if(request.getParameter("equipRegiment")!= null ){
		reg = request.getParameter("equipRegiment");
		regp=request.getParameter("equipRegiment");
	}
	if(request.getParameter("equipType")!= null ){
		et = request.getParameter("equipType");
...
<body>
	...
	<div class="top">
		<form action="equipLocationsAll.jsp" id="locations" method="get">
		<table>
			<tr>
    ...
    $(document).ready(function() 
    		{ 
    		    ...
    		    { 
    		     ...
    		     $('#equipRegiment').on('change', function() {
    		    	location.replace("equipLocationsAll.jsp?equipRegiment="+$('#equipRegiment option:selected').val()+"&gis_setting="+$('input[name=gis_setting]:checked').val());
    	  		 });

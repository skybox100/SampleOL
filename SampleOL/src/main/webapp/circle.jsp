...
<%
	...
	String regp = "28여단";
	String rcp = "전체";
	if(request.getParameter("gis_setting")!= null && request.getParameter("gis_setting2")!=null && request.getParameter("reg") != null && request.getParameter("rc") != null){
...
<body>
	...
	<div class="footer">
		<form action="circle.jsp" id="circle" method="get">
		<table>
			<tr>
				...
				<font size="1px" style="font-weight: bold" id="gis_setting2">
		 			...
		 			<input type="radio" name="reg" class="reg2" value="9사단"  style="display:none">
		 			<input type="radio" name="reg" class="reg2" value="28여단" checked style="display:none">
    ...
    <script>
        ...
        $(document).ready(function() 
        	...
        	function submit(){
        		document.getElementById('circle').submit();
